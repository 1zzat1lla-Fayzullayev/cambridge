        ...
        <>
            ...
            <div className={`menu duration-300 h-full xl:w-[calc(100%-170px)] lg:hidden max-w-xl xl:max-w-none xl:h-auto bg-white fixed inset-0 z-[99] pt-20 lg:pt-24 px-5 pb-6 flex flex-col justify-between xl:hidden dark:bg-[#121624] ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <div className="xl:flex xl:gap-x-5">
                    <a href="/ru/teachers" className="font-medium block text-base text-center rounded-xl p-4 mb-2.5 cursor-pointer dark:text-white bg-[#f8f9fa1a] dark:bg-opacity-10">Учителя</a>
                    <a href="/ru/courses" className="font-medium block text-base text-center rounded-xl p-4 mb-2.5 cursor-pointer dark:text-white bg-[#f8f9fa1a] dark:bg-opacity-10">Курсы</a>
                    <a href="/ru/branches" className="font-medium block text-base text-center rounded-xl p-4 mb-2.5 cursor-pointer dark:text-white bg-[#f8f9fa1a] dark:bg-opacity-10">Филиалы</a>
                    <a href="/ru/check-certificate" className="font-medium block text-base text-center rounded-xl p-4 mb-2.5 cursor-pointer dark:text-white bg-[#f8f9fa1a] dark:bg-opacity-10">Сертификат</a>
